...
public:
	...
	int* recorrerAnchuraMa(GrafoMatriz g, TipoG org, Cola *ColaAux);
	int* recorrerProfMa(GrafoMatriz g, TipoG org, Pila *PilaAux);
	int* recorrerAnchuraMa(GrafoMatriz g, int v, Cola *ColaAux);
	int* recorrerProfMa(GrafoMatriz g, int v, Pila *PilaAux);
...
int* RecorreGrafo::recorrerAnchuraMa(GrafoMatriz g, int v, Cola *ColaAux){	//recorre grafo en anchura recibiendo numero de vertice inicial
	int w;
	Cola cola;
	int* m;
...
int* RecorreGrafo::recorrerAnchuraMa(GrafoMatriz g, TipoG org, Cola *ColaAux) {	//recorre grafo en anchura recibiendo nombre de vertice inicial
	int v = g.getNumVertice(org);
	if (v >= 0){
		recorrerAnchuraMa(g,v,ColaAux);
	} 
}	

int * RecorreGrafo::recorrerProfMa(GrafoMatriz g, int v, Pila *PilaAux) {  		//recorre grafo en profundidad recibiendo numero de vertice inicial
	int w;
	Pila pila;
	int* m;
...
int* RecorreGrafo::recorrerProfMa(GrafoMatriz g, TipoG org, Pila *PilaAux) {		//recorre grafo en profundidad recibiendo nombre de vertice inicial
	int v = g.getNumVertice(org);
	if (v >= 0){
		recorrerProfMa(g,v,PilaAux);
	}
}
